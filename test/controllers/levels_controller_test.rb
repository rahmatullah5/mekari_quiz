...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { cover: @level.cover, description: @level.description, title: @level.title } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { cover: @level.cover, description: @level.description, title: @level.title } }
